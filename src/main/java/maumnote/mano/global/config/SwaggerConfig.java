                                        ...
                                        .content(new Content()
                                                .addMediaType("application/json", new MediaType()
                                                        .schema(new Schema<Object>()
                                                                ...
                                                                .addProperty("email", new Schema<Object>()
                                                                        .type("string")
                                                                        .description("이메일")
                                                                        .example("test@test.com"))
                                                                .addProperty("password", new Schema<Object>()
                                                                        .type("string")
                                                                        .description("비밀번호")
                                                                        .example("test")
                                                                )
                                ...
                                .responses(new ApiResponses()
                                        .addApiResponse("200", new ApiResponse()
                                                ...
                                                .content(new Content().addMediaType("application/json", new MediaType()
                                                        .schema(new Schema<Object>()
                                                                .type("object")
                                                                .addProperty("statusCode", new Schema<Object>()
                                                                        .type("integer")
                                                                        .example(200))
                                                                .addProperty("responseMsg", new Schema<Object>()
                                                                        .type("string")
                                                                        .example("로그인 성공"))
                                                                .addProperty("data", new Schema<Object>()
                                                                        .type("object") // data는 객체 타입
                                                                        .addProperty("accessToken", new Schema<Object>()
                                                                                .type("string")
                                                                        ...
                                                                        .addProperty("refreshToken", new Schema<Object>()
                                                                                .type("string")
